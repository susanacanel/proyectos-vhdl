...
- [022. Descripción: memoria estática, asincrónica con bus de datos bidireccional, SRAM.](https://www.youtube.com/watch?v=5MokoXlPq1o)
...
- [113. Testbench. Genera archivo de salida de formato compatible con planilla electrónica.](https://www.youtube.com/watch?v=oICeLzY5nYY)
- [114. Utilizando el shell Bash para generar el archivo de entrada al testbench.](https://www.youtube.com/watch?v=7fgOw2_bedk)
- [115. Testbench: archivos con datos de tipo bit_vector, problemas detectados.](https://www.youtube.com/watch?v=ReKqCeJ3Xkw)
- [116. Testbench: que usa archivos y datos string y std_logic_vector. Conversión de datos.](https://www.youtube.com/watch?v=jHhFgJ90Hzo)
- [117. Testbench con una función declarada dentro del código.](https://www.youtube.com/watch?v=wWwfdA3fPEc)
- [118. Declarando una función en  un package y compilando todo con GHDL y con ModelSim.](https://www.youtube.com/watch?v=69mzp_kVM4I)
- [119. Testbench. Uso de procedimientos. Declaración en package. Diferencias con funciones](https://www.youtube.com/watch?v=50LvJMOjhHw)
- [120. Testbench del sumador serie usado para generar la tabla del 7. Graba un archivo.](https://www.youtube.com/watch?v=7a47T0Da4yw)
- [121. Divisor de frecuencia, genera dos frecuencias, 200Hz y 1Hz. Ejecución en plaqueta.](https://www.youtube.com/watch?v=33hjODspUOY)
- [122. 1era.Parte: diseño estructural sincrónico, sumador serie. Ejecución en la plaqueta..](https://www.youtube.com/watch?v=xB50UYudInw)
- [123. Testbench del 1er. bloque del sumador serie. Análisis de la simulación.](https://www.youtube.com/watch?v=EJFYxRDzGOs)
- [124. Descripción como máquina de estado, testbench y simulación de un sumador serie.](https://www.youtube.com/watch?v=xCV512F2HLo)
- [125. Diseño estructural: divisor de frecuencia, antirrebote, sumador serie. Ejecución.](https://www.youtube.com/watch?v=JAD5nL3mIng)
- [126. Diseño estructural, sum.serie, div. frec, antirrebote, conversores bin2BCD, BCD-7seg](https://www.youtube.com/watch?v=6wQs7-2lPW8)
- [127. Descripción de una memoria estática, sincrónica, SRAM. Ejecución en la plaqueta DE1](https://www.youtube.com/watch?v=rpFgFT7pwrc)
- [128. Descripción: memoria estática sincrónica con bus de datos bidireccional, SRAM. DE1.](https://www.youtube.com/watch?v=znC__UqGoog)
- [129. Testbench memoria SRAM estática, sincrónica, bus bidireccional. Usa procedimientos.](https://www.youtube.com/watch?v=emR1UD1Ecsc)
- [130. Simulación de la memoria SRAM estática, sincrónica, con bus bidireccional. Script.](https://www.youtube.com/watch?v=iXZ05uUWfVY)
- [131. (1/2) Trasmisor de la UART RS-232. Prueba transmitiendo de la plaqueta a la computadora.](https://www.youtube.com/watch?v=yoBSufete8Y)
- [131. (2/2) Parte final. Transmisor UART RS-232. Uso cable HL-340. Terminal PuTTY.](https://www.youtube.com/watch?v=iPpmXI0MvB4)
